...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">            });</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">          }</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">        })();</span></span></code></pre></div><p>Replace the placeholders with your own values:</p><table tabindex="0"><thead><tr><th>Placeholder</th><th>Example</th><th>Description</th></tr></thead><tbody><tr><td><code>&lt;LIBRISLOG-URL&gt;</code></td><td><code>http://192.168.1.100:8000</code></td><td>The base URL of your LibrisLog instance (http or https)</td></tr><tr><td><code>&lt;API-KEY&gt;</code></td><td><code>lk_nRHsF3jxIBDa9u....</code></td><td>An API key with access to the statistics endpoint</td></tr></tbody></table><p>The <code>updateInterval</code> is specified in seconds. <code>300</code> equals 5 minutes.</p><h2 id="cors" tabindex="-1">CORS <a class="header-anchor" href="#cors" aria-label="Permalink to &quot;CORS&quot;">​</a></h2><p>Since the widget runs inside the Dashy iframe and fetches the LibrisLog API directly from the browser, you must add your Dashy URL to the <a href="/guide/configuration.html#core-settings"><code>CORS_ORIGINS</code></a> environment variable of the LibrisLog backend. For example:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>CORS_ORIGINS=[&quot;https://dashy.YOUR-DOMAIN&quot;]</span></span></code></pre></div><h2 id="result" tabindex="-1">Result <a class="header-anchor" href="#result" aria-label="Permalink to &quot;Result&quot;">​</a></h2><p><img src="`+l+'" alt="Dashy Widget" loading="lazy"></p>',16)])])}const g=a(e,[["render",p]]);export{F as __pageData,g as default};
